...
sample_name <- "Ctrl"
counts$Peaks <- counts$Peaks[, grepl("-1", colnames(counts$Peaks))]
counts$`Gene Expression` <- counts$`Gene Expression`[, grepl("-1", colnames(counts$`Gene Expression`))] # nolint: line_length_linter.
...
# separate counts based on sample IDs (optional)
counts$Peaks <- counts$Peaks[, grepl("-1", colnames(counts$Peaks))]
counts$`Gene Expression` <- counts$`Gene Expression`[, grepl("-1", colnames(counts$`Gene Expression`))]
